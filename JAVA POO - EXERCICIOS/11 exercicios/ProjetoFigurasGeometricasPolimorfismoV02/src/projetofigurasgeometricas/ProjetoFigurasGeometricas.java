...
public class ProjetoFigurasGeometricas {
    ...
    public ProjetoFigurasGeometricas() {
        mostrarTodasAsFiguras();
        somaAreasDeTodasAsFiguras();
        figuraComMaiorPerimetro();
        circuloComMaiorDiametro();
    }
    
    public static void main(String[] args) {        
        new ProjetoFigurasGeometricas(); //chama o construtor acima
    }
    
    public void mostrarTodasAsFiguras() {
    ...
    public void somaAreasDeTodasAsFiguras() {
    ...
    public void figuraComMaiorPerimetro() {
    ...
    public void circuloComMaiorDiametro() {

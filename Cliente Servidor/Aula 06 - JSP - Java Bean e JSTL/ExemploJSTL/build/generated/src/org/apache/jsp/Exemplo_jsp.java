...
public final class Exemplo_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      java.util.Date agora = null;
      synchronized (_jspx_page_context) {
        agora = (java.util.Date) _jspx_page_context.getAttribute("agora", PageContext.PAGE_SCOPE);
        if (agora == null){
          agora = new java.util.Date();
          _jspx_page_context.setAttribute("agora", agora, PageContext.PAGE_SCOPE);
        }
      }
      out.write("\r\n");
      out.write("<br>Versão Curta: ");
      if (_jspx_meth_fmt_formatDate_0(_jspx_page_context))
        return;
      out.write(" \r\n");
      out.write("<br>Versão Longa: ");
  ...
  private boolean _jspx_meth_fmt_formatDate_0(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_formatDate_0.setValue((java.util.Date) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${agora}", java.util.Date.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_fmt_formatDate_1(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_formatDate_1.setValue((java.util.Date) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${agora}", java.util.Date.class, (PageContext)_jspx_page_context, null));
    _jspx_th_fmt_formatDate_1.setDateStyle("full");

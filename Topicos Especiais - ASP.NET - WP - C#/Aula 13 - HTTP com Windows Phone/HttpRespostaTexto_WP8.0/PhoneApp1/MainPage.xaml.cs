...
namespace PhoneApp1
{
    public partial class MainPage : PhoneApplicationPage
    {
        ...
        void dispatcherTimer_Tick(object sender, object e)
        {
            ...
            if (quantSegundos == 14)
            {
                txtresp.Text = "Err0: Timeout. Não foi possível completar a solicitação. Por favor, verifique a conexão de seu aparelho com a Internet e a intensidade do sinal de rede.";
                tiempo.Stop();
            }
            if (!responseString.Equals(""))
            {
                ...
                string []chars = {"<<"};
                string[] vet = responseString.Split(chars, StringSplitOptions.None);

                String res = "";
                int qtde = Convert.ToInt16(vet[0]);
                int pos = 1;
                for(int i=0; i<qtde; i++) {
                    res += vet[pos] + ", " + vet[pos + 1] + ", " + vet[pos + 2] + ", " + vet[pos + 3] + "\n";
                    pos += 4;
                }
                txtresp.Text = res;
        ...
        class MyThreadClass
        {
            ...
            public void inicia()
            {
                string sURL = "http://cpa.cruzeirodosulvirtual.com.br:8080/avl1410/geraTexto.jsp";
            ...
            private void GetRequestStreamCallback(IAsyncResult asynchronousResult)
            {
                ...
                {
                    responseString = "Err2: Não foi possível completar a solicitação. \n\nPor favor, verifique a conexão de seu aparelho com a Internet e a intensidade do sinal da rede de dados." + qualquer.Message;
                }
            ...
            private void GetResponseCallback(IAsyncResult asynchronousResult)
            {
                try
                {
                    ...
                    System.IO.StreamReader streamRead = new System.IO.StreamReader(streamResponse, Encoding.GetEncoding("utf-8"));
